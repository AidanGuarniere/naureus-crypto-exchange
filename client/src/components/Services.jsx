...
const ServiceCard = ({ color, title, icon, subtitle }) => (
  <div className="flex flex-row justify-start items-start white-glassmorphism p-3 m-2 cursor-pointer hover:shadow-xl">
    <div className={`w-8 h-10 rounded-full flex justify-center items-center ${color}`}>
      {icon}
    </div>
...
const Services = () => {
  return (
    <div className="md:flex w-full justify-center items-center gradient-bg-services">
